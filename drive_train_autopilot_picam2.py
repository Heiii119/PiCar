...
class PiCam2Manager:
    ...
    def annotate(self, text):
        # Simple annotation via QtGL preview doesn't support overlay text directly in all environments;
        # fallback: no-op or extend to draw using numpy if needed.
        # For robustness across environments, we skip live overlay drawing here.
        pass
