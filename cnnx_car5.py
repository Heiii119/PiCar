...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=5000)    "throttle": THROTTLE_STOPPED,
    "steering": STEERING_CENTER
}
...
def start_uturn():
    global uturn_active, uturn_stage, uturn_start_time
    uturn_active = True
    uturn_stage = 0
    uturn_start_time = time.time()
